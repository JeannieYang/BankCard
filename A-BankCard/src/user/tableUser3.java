...
public class tableUser3 extends JFrame {
...
//			System.out.println(str);//检验
			rs = dbcon.executeQuery("select * from [userevent] where inputID = '"+str+"'");	
			//获取查询结果中的列名，填充表格模式列
	...
	public static void main(String[] args) {
		tableUser3 w = new tableUser3(str);
		w.setVisible(true);
	}
}